import type {AccessInheritanceRule, URI} from "@hia/core";
...
import {AccessMode, InMemoryWithdrawStore} from "@hia/core";
...
export class AuthSpec{
    ...
    private auth = new JWTAuthenticator(
        new KeyStoreMock(),
        new InMemoryWithdrawStore(),
